...
import eu.aily.external.fcm.auth.HttpBasicAuth;
import eu.aily.external.fcm.auth.ApiKeyAuth;
import eu.aily.external.fcm.auth.OAuth;
import eu.aily.external.fcm.auth.OAuth.AccessTokenListener;
import eu.aily.external.fcm.auth.OAuthFlow;
...
public class ApiClient {
   ...
   public void createDefaultAdapter() {
        ...
        adapterBuilder = new RestAdapter
                .Builder()
                .setEndpoint("https://fcm.googleapis.com")
